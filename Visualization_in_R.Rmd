...
# We can also do this another way by using the function summarise_all(). Then you need to define the statistical functions (mean, median, sd etc.) within another function called list(). This function has been updated recently and although it still works, the summarise _if, _at, and _all verbs have been superceded by across and pick. Below you'll see the same tasks done with the old summarise_all and across.
